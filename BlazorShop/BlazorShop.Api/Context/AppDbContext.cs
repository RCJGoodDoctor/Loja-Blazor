...
public class AppDbContext:DbContext
{
    ...
    // Criação das tabela no entity framework migration
    public DbSet<Carrinho> Carrinhos { get; set; } // tabela para ser criado no MySql em referencia a classe
    public DbSet<CarrinhoItem> CarrinhoItens { get; set; } // tabela para ser criado no MySql em referencia a classe
    public DbSet<Produto> Produtos { get; set; } // tabela para ser criado no MySql em referencia a classe
    public DbSet<Usuario> Usuarios { get; set; } // tabela para ser criado no MySql em referencia a classe
    public DbSet<Categoria>Categorias { get; set; } // tabela para ser criado no MySql em referencia a classe
